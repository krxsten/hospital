...
namespace Hospital.WebProject.Seed
{
    public class DiagnoseConfiguration : IEntityTypeConfiguration<Diagnose>
    {
        ...
        public IEnumerable<Diagnose> CreateDiagnoses()
        {
            ...
            {
                new Diagnose { ID = new Guid("91b25ace-9e01-4c25-b0ea-3c8bad060315"), Name = "Influenza", ImageURL = "https://res.cloudinary.com/dyoxqki3d/image/upload/q_auto/f_auto/v1775043137/716959ed-ecf1-4c3e-a6ad-dfb7caca7863_mxmyot.png", PublicID="716959ed-ecf1-4c3e-a6ad-dfb7caca7863" },
                ...
                new Diagnose { ID = new Guid("2dfdf306-41d8-4aca-abd6-91ed7d4adc8a"), Name = "Bronchitis", ImageURL = "https://res.cloudinary.com/dyoxqki3d/image/upload/q_auto/f_auto/v1775043330/c4510bbe-5309-4952-9ccd-326308a2c64a_vy0qwz.png", PublicID="c4510bbe-5309-4952-9ccd-326308a2c64a_vy0qwz"  }
            };
