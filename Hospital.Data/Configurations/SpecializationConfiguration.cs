    ...
    public class SpecializationConfiguration : IEntityTypeConfiguration<Specialization>
    {
        public void Configure(EntityTypeBuilder<Specialization> builder)
        {
            builder.HasData(new Specialization { ID = new Guid("8a42cdba-ff58-4129-aea8-ae4c3b32f353"), SpecializationName = "Infectious Disease", ImageURL = "https://res.cloudinary.com/dyoxqki3d/image/upload/q_auto/f_auto/v1775117702/Screenshot_2026-04-02_111137_nbbhc6.png", PublicID = "Screenshot_2026-04-02_111137_nbbhc6" },
                ...
                new Specialization { ID = new Guid("a5519f22-cefb-4771-a5e9-de7b40817df8"), SpecializationName = "Rheumatology", ImageURL = "https://res.cloudinary.com/dyoxqki3d/image/upload/q_auto/f_auto/v1775117703/Screenshot_2026-04-02_111632_kl3iuj.png", PublicID = "Screenshot_2026-04-02_111632_kl3iuj" },
                new Specialization { ID = new Guid("4ee4ce69-da26-4f66-85cf-30623200cbf4"), SpecializationName = "Orthopedics", ImageURL = "https://res.cloudinary.com/dyoxqki3d/image/upload/q_auto/f_auto/v1775117703/Screenshot_2026-04-02_111739_yxp8r4.png", PublicID = "Screenshot_2026-04-02_111739_yxp8r4" },
